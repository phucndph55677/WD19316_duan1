                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="gioi_tinh" class="form-control">
                                        ...
                                        <option value="0" <?=$khachHang['gioi_tinh'] == 0 ? 'selected' : ''?>>Nữ
                                        </option>
                                    </select>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="trang_thai" class="form-control">
                                        <option value="1" <?=$khachHang['trang_thai'] == 1 ? 'selected' : ''?>>Active
                                        </option>
                                        <option value="0" <?=$khachHang['trang_thai'] == 0 ? 'selected' : ''?>>Inactive
                                        </option>
                                    </select>
