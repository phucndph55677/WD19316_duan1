        ...
        <div class="footer-top section-padding">
            <div class="container">
                <div class="row">
                        ...
                        <div class="widget-item">
                            ...
                            <div class="widget-body">
                                <address class="contact-block">
                                    <ul>
                                        <li><i class="pe-7s-home"></i> 13 P.Trịnh Văn Bô, Xuân Phương, Nam Từ Liêm, Hà Nội</li>
                                        <li><i class="pe-7s-mail"></i> <a href="mailto:ndp112005@gmail.com">abc@gmail.com </a></li>
                                        <li><i class="pe-7s-call"></i> <a href="tel:(012)800456789987">(84) 8386 8386</a></li>
                                    </ul>
                                </address>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="widget-item">
                            <h6 class="widget-title">Followw</h6>
                ...
                <div class="row align-items-center mt-20">
                    <div class="col-md-6">
                        <div class="newsletter-wrapper">
                            <h6 class="widget-title-text">Đăng ký để biết thêm thông tin chi tiết</h6>
